    ...
    module ContentTypeWhitelist
      ...
      def content_type_allowlist
        if respond_to?(:content_type_whitelist)
          ActiveSupport::Deprecation.new.warn "#content_type_whitelist is deprecated, use #content_type_allowlist instead." unless instance_variable_defined?(:@content_type_whitelist_warned)
